...
\textbf{\underline{SOLUSI}}
\begin{enumerate}
    \item Diketahui bahwa $a_n>0$ untuk setiap $n\geq 1$. dan secara rekrusif diperoleh
    \begin{align*}
        a_{n+1}&\leq a_n+\dfrac{1}{(n+1)^2}\leq a_{n-1}+\dfrac{1}{n^2}+\dfrac{1}{(n+1)^2}\leq \cdots \leq a_1+\sum_{k=2}^{n+1}\dfrac{1}{k^2}
    \end{align*}
    \item \begin{enumerate}
        ...
        \item  Misalkan $r(x)s(x)\in\ker f$ untuk suatu $r(x),s(x)\in\Z[x]$. 
    \end{enumerate}
    \item \begin{enumerate}
        \item 
    \end{enumerate}
