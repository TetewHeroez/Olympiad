...
\begin{answer}[C. 528]
  ...
  Jika $J$ dan $K$ harus berdampingan pada $5$-blok yang dipilih, kita bisa menyatukannya dalam satu "kotak" $\boxed{JK}$ atau $\boxed{KJ}$ (2 kemungkinan).
  ...
  \begin{itemize}
    ...
    \item Kita menyusun bentuk blok $\boxed{JK}$ bersama $3$ huruf tersebut menjadi: $4! = 24$ susunan.
